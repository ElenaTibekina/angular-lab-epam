...
@Component({
  selector: 'app-text-pokemons-list',
  templateUrl: './text-pokemons-list.component.html',
  styleUrls: ['./text-pokemons-list.component.scss']
})
export class TextPokemonsListComponent  {
